...
import com.academy.app.MainActivity;
...
public class GetNameInForeground extends AbstractGetNameTask {
  ...
  protected String fetchToken() throws IOException {
      try {
          ...
          //activity.showErrorDialog(playEx.getConnectionStatusCode());
    	  Toast.makeText(activity, playEx.getConnectionStatusCode(), Toast.LENGTH_SHORT).show();
      } catch (UserRecoverableAuthException userRecoverableException) {
          // Unable to authenticate, but the user can fix this.
          // Forward the user to the appropriate activity.
          activity.startActivityForResult(userRecoverableException.getIntent(), requestCode);
